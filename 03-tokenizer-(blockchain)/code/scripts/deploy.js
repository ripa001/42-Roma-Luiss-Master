...
async function main() {
  console.log("🛹 Starting Trick42Token deployment...");
  ...
  console.log("✅ Trick42Token deployed to:", await trick42Token.getAddress());
  
  // Wait for block confirmations
  console.log("\n⏳ Waiting for block confirmations...");
  const deploymentTx = trick42Token.deploymentTransaction();
  const confirmations = hre.network.name === "hardhat" || hre.network.name === "localhost" ? 1 : 5;
